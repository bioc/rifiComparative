...
`loading_fun`: you need to load the rifi statistics outputs from
each condition and put all in one directory. The "cdt" is added referring to the sample condition. 
...
A serie of plots could be generated using `figures_fun` function. The function
...
<br/><br/>
``` {r Figure 2, echo = FALSE, fig.cap = "**log2FC(Decay rate vs. Synthesis rate)**", out.width = '100%'}
...
<br/><br/>
``` {r Figure 3, echo = FALSE, fig.cap = "**log2FC(heatscatter Decay rate vs. Synthesis rate)**", out.width = '100%'}
...
density in both conditions. Condition 1 and 2 could be
indicated.

<br/><br/>
``` {r Figure 4, echo = FALSE, fig.cap = "**HL density**", out.width = '100%'}
...
<br/><br/>
``` {r Figure 5:, echo = FALSE, fig.cap = "**HL histogram categories**", out.width = '100%'}
...
<br/><br/>
``` {r Figure 6:, echo = FALSE, fig.cap = "**HL Scatter Plot **", out.width = '100%'}
...
<br/><br/>
``` {r Figure 7:, echo = FALSE, fig.cap = "**Volcano Plot**", out.width = '100%'}
