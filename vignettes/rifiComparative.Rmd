...
P-values from statistical tests are estimated. rifiComparative generates dataframe summary, genome plot and several figures (refer to section Plots for more details).
...
A scatter plot of the bin/probe half-life. 
