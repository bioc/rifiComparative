...
developed a new workflow, rifiComparative, with an easy strategy to make 
...
The fragments resultinf from clustering from HL and intensity are compared using
